...
function calcCategoryRecord(m, category, domain, cache) {
    var otherdomains = mgnlq_model_1.Model.getDomainsForCategory(m, category);
    ...
    function getDomainRecords(dom) {
        if (cache[dom]) {
            ...
            var p = mgnlq_model_1.Model.getExpandedRecordsFull(m, dom);
...
function graphDomain(domain, m, domainRecordCache) {
  ...
  `;
    ...
    var cats = mgnlq_model_1.Model.getCategoriesForDomain(m, domain);
...
function tabDomain(domain, m) {
    ...
    var modelCache = {};
    var cats = mgnlq_model_1.Model.getCategoriesForDomain(m, domain);
    cats = mgnlq_model_1.Model.sortCategoriesByImportance(m.full.domain[domain].categories || {}, cats);
