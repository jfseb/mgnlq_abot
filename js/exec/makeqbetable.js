...
function makeTable(categories, theModel) {
    ...
    //
    var aFilteredDomains = mgnlq_model_1.Model.getDomainsForCategory(theModel, categories[0]);
    categories.forEach(category => {
        var catsForDomain = mgnlq_model_1.Model.getDomainsForCategory(theModel, category);
    ...
    //
    var columns = mgnlq_model_1.Model.getTableColumns(theModel, domain);
    if (columns.length === 0) {
        return {
